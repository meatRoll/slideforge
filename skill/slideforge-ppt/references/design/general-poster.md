<!-- From Kimi open-kimi-ppt/reference/general-poster.md · poster/infographic single-page design guide. Load only for poster/infographic tasks. Re-sync from the Kimi repo if it changes. -->
