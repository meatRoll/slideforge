<!-- From Kimi open-kimi-ppt/reference/fonts.md · SlideForge pptd-spec.md references ./shapes.md · ./fonts.md (dangling in docs/); bundled here so the spec links resolve within the skill. Re-sync from the Kimi repo if it changes. -->
