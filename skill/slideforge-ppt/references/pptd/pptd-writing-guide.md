<!-- Synced from docs/pptd-writing-guide.md · self-contained skill copy · re-sync when source changes. Cross-links between pptd-*.md resolve within this folder. Repo-root links rewritten to ../../../../. -->
