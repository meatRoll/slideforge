<!-- Synced from docs/pptd-writing-guide.md · self-contained skill copy · re-sync when source changes. Cross-links resolve within this folder; repo-root links rewritten to ../../../../. -->
