<!-- Synced from docs/pptd-layout-extension.md · self-contained skill copy · re-sync when source changes. Cross-links between pptd-*.md resolve within this folder. -->
