<!-- Synced from docs/pptd-spec.md · self-contained skill copy · re-sync when source changes. Cross-links between pptd-*.md resolve within this folder. -->

<!--
Provenance: verbatim mirror of Moonshot's canonical PPTD v2 format spec
(open-kimi-ppt/reference/pptd.md, 2029 lines). READ-ONLY — do not edit here;
update the upstream and re-copy. SlideForge's additions over this spec live in
./pptd-layout-extension.md. A deck using only the fields below is 100%
canonical PPTD v2; the extension fields are opt-in.
-->
